...
- **A cobertura do mês nasce em 0% e só atinge o patamar no fim do mês.** Medido em julho/2026, sobre 845 UCs: dia 3 = 1,9% (16 UCs) · dia 10 = 14,9% · dia 20 = 36,9% · dia 31 = 62,1% (525 UCs). A causa não é defeito de cálculo: a distribuidora emite ao longo do mês inteiro, e ainda há a latência de captura no Fattureweb (mediana 2 dias, 3º quartil 5). Efeito prático: nos primeiros dias de cada mês o número-manchete do painel é ~0% e o card vizinho diz "845 UCs sem fatura no mês", que lê como catástrofe sem que nada esteja errado — observado em 2026-08-03. É a mesma patologia do atraso por mês-calendário, que já foi trocado por atraso por ciclo; a métrica por ciclo (`clientes_atrasados`) se comporta bem no início do mês, porque compara cada cliente com o ciclo dele. Decisão do Pedro em 2026-08-03: **deixar como está e investigar depois**. Opções levantadas: comparar com o mesmo dia do mês anterior (sem limiar, exige um número novo no backend), usar o último mês fechado como manchete, ou janela móvel de 30 dias (nunca zera, mas mistura dois ciclos de faturamento).
